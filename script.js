(() => {
  ...
  const fa = {
    "FIXED SUPPLY":"عرضه ثابت", "NO MINT":"بدون مینت", "TAX":"مالیات", "LET HIM COOK":"بگذارید کار خودش را بکند", "SEND IT":"بفرستیدش", "BULLISH":"نگاه صعودی", "NO PANIC":"بدون نگرانی", "STAY KINDO":"KINDO بمانید", "Important:":"مهم:", "Never trust a contract address from replies, DMs, or random posts. Verify it here before swapping.":"هرگز به آدرس قراردادی که در پاسخ‌ها، پیام‌های خصوصی یا پست‌های تصادفی می‌بینید اعتماد نکنید. پیش از معامله آن را در همین‌جا بررسی کنید.", "“Are we alone in this universe?”":"«آیا در این جهان تنها هستیم؟»", "Arrival":"ورود", "Find the travelers":"پیدا کردن مسافران", "Beyond Earth":"فراتر از زمین", "IN PROGRESS":"در حال انجام", "NEXT":"بعدی", "LATER":"بعدتر", "TRANSPARENT WALLETS":"کیف‌پول‌های شفاف",
