(() => {
  ...
  const fa = {
    "FIXED SUPPLY":"عرضه ثابت", "NO MINT":"بدون مینت", "TAX":"مالیات", "LET HIM COOK":"بگذارید کار خودش را بکند", "SEND IT":"بفرستیدش", "BULLISH":"نگاه صعودی", "NO PANIC":"بدون نگرانی", "STAY KINDO":"KINDO بمانید", "Important:":"مهم:", "“Are we alone in this universe?”":"«آیا در این جهان تنها هستیم؟»",
